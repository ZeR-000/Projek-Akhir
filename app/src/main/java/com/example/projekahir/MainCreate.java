    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Snama.equals("")){
                    Enama.requestFocus();
                    Toast.makeText(MainCreate.this, "Silahkan isi Nama Handphone",
                    ...
                    Eimage.setImageResource(R.drawable.ic_phone);
                    Enama.setText("");
                    Etipe.setText("");
                    Ewarna.setText("");
                    Eharga.setText("");
                    Toast.makeText(MainCreate.this, "Data telah ditambah",
                            Toast.LENGTH_SHORT).show();
                    db.CreateHandphone(new Handphone(null,Simage, Snama, Stipe, Swarna, Sharga));
